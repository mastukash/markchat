...
namespace markchat.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> UserInfo()
        {
            ...
            return Request.CreateResponse(HttpStatusCode.OK, new { user.Email, FullName = user.FullName != "" ? user.FullName : user.PhoneNumber, UserPhotoUrl = GetUrlUserPhoto(user) });
        }
